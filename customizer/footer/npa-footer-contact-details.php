...
$wp_customize->add_control('npa_contact', array(
  'label'         => __('Contact Title', 'npa'),
  'description'   => __('Such as, যোগাযোগ, ঠিকানা বা সম্পাদকীয় কার্যালয়'),
...
$wp_customize->add_control('npa_address', array(
  'label'         => __('Address', 'npa'),
  'description'   => __('Type Here Address'),
